...
- Upstream of this branch is https://github.com/edgebus/deployment-docker-swarm/tree/prometheus%23main
...
| ----------------- | ------------------------------------- | ------------------------------------------------------------ |
| Release Candidate | `prometheus[a-z]*-YYYYMMDDhhmmss-rcXxxx` | create deploy pipelines against ALL (except `prod`) clusters |
| Release           | `prometheus[a-z]*-YYYYMMDDhhmmss`        | create deploy pipelines against ALL clusters                 |

Examples:

- `prometheussomething-20250503-rc000`
- `prometheussomething-20250503-rc00`
- `prometheussomething-20250503-rc0`
- `prometheussomething-2025050323-rc0`
- `prometheussomething-202505032359-rc0`
- `prometheussomething-20250503235959-rc0`
- `prometheussomething-20250503`
- `prometheussomething-2025050323`
- `prometheussomething-202505032359`
- `prometheussomething-20250503235959`
...
4. Monitoring
   ...
   docker service logs --follow  "${DEPLOYMENT_STACK_NAME}_prometheus"      #Used to view the logs of a Docker service in real-time.
   ```
