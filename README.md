...
- Upstream of this branch is https://github.com/edgebus/deployment-docker-swarm/tree/grafana%23main
...
| ----------------- | ------------------------------------- | ------------------------------------------------------------ |
| Release Candidate | `grafana[a-z]*-YYYYMMDDhhmmss-rcXxxx` | create deploy pipelines against ALL (except `prod`) clusters |
| Release           | `grafana[a-z]*-YYYYMMDDhhmmss`        | create deploy pipelines against ALL clusters                 |

Examples:

- `grafanasomething-20250503-rc000`
- `grafanasomething-20250503-rc00`
- `grafanasomething-20250503-rc0`
- `grafanasomething-2025050323-rc0`
- `grafanasomething-202505032359-rc0`
- `grafanasomething-20250503235959-rc0`
- `grafanasomething-20250503`
- `grafanasomething-2025050323`
- `grafanasomething-202505032359`
- `grafanasomething-20250503235959`
...
4. Monitoring
   ...
   docker service logs --follow  "${DEPLOYMENT_STACK_NAME}_grafana"      #Used to view the logs of a Docker service in real-time.
   ```
